...
const EnhancedPropertyGrid: React.FC<PropertyGridProps> = ({ posts, categories, images }) => {
  ...
  const handleCardClick = (aptId: string) => {
    navigate(`/home/apartment/${aptId}`);
  };
        ...
        <Card
          ...
          cover={
            <div className="h-48 overflow-hidden relative">
              <img
                alt={post.title}
                src={images[post.aptId] || "https://via.placeholder.com/300x200?text=No+Image"}
          ...
          onClick={() => handleCardClick(post.aptId)}
        >
          <div className="h-36">
